! function(a) {
    ...
    function c(b, c, d) {
        ...
        var g = b.cloneNode();
        return b.style.display = "none", c === !1 ? a(b).before(a(g).attr(
            "data-upload-preview", f)) : (g.id = c, a(b).removeAttr(
            "id").before(a(g).attr("data-upload-preview", f))), e
    }
    ...
    function d(b, c, d, e, f) {
        ...
        return a(h).attr("data-upload-preview", e), h.appendChild(i), h.style
            .cursor = "pointer", "before" == d ? g.insertBefore(h, f) : g.appendChild(
                h), g
    }
    ...
    function g(a, b) {
        for (var c = a.substr((~-a.lastIndexOf(".") >>> 0) + 2), d = b.split(
            "/"), e = d.length - 1; e >= 0; e--)
            if (c == d[e]) return !0;
        return !1
    }
    a.fn.previewimage = function(h) {
        var h = a.extend({
            ...
            m = a(h.div),
            n = 0;
        if (i.length && m.length && "" !== j) b(i[0]), l.on("change",
            "input[name='" + j + "[]']", function() {
                var b = this,
                    i = this.files;
                if (i && i[0])
                    if (g(i[0].name, h.ext) && f(i[0].size, h.imgsize)) {
                        ...
                        l.onload = function(a) {
                            var f = a.target.result,
                                g = c(b, k, n),
                                i = e(f, h.imgwidth, h.imgheight, !
                                    1);
                            m.prepend(d(h.imgdel, h.delname, h.position,
                                g, i)), n++
                        }, l.readAsDataURL(this.files[0])
                    } else alert(
                        "Your input is not an image or file size are too big"
                    );
                else {
                    b.select(), b.blur();
                    ...
                    if (g(o, h.ext)) {
                        ...
                        m.prepend(d(h.imgdel, h.delname, h.position, p,
                            q)), n++
                    }
                }
            });
