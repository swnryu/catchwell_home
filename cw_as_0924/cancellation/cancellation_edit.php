...
?>
	...
	<form method="post" action="cancellation_edit_ok.php" name="tx_editor_form" enctype="multipart/form-data" >
	...
	<!-- 20230913 exchange_tracking_number add -->
	<tr>
		<th>재출고송장번호</th>
		<td><input name="exchange_tracking_number" class="form-control input-sm" value="<?=$row->exchange_tracking_number?>" placeholder="재출고송장번호" autocomplete="off"></td>
	</tr>
...
function deleteit() {
	...
	if (confirm("반품/교환 신청서를 삭제할까요?")) {
		...
		form.isdel.value = 'y';
		form.action = "cancellation_edit_ok.php";
		form.submit();
	}
}
