...
if($idx==0){ //new
    ...
    //20230913 exchange_tracking_number 추가 
    $exchange_tracking_number = isset($_POST['exchange_tracking_number']) ? $_POST['exchange_tracking_number'] : "";

	if ($status==0) {
		$date_completed = date('Y-m-d');
		$result_type = -1;
	}
    //20230913 exchange_tracking_number='$exchange_tracking_number' 추가
		...
		)) 
	{
		...
		$tools->alertJavaGo("등록 되었습니다.", "cancellation_list.php" );
