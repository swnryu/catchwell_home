...
class CKakaoNotificationTalkEx {
	...
	//카카오알림톡 NEW
    function notiMsg_new($db, $customerName, $customerPhone, $regNumber, $modelName, $brokenType, $adminMemo, $parcelNo, $return_url,$pic_name)
    {
        ...
        else
        {
			...
			if($pic_name == "이승환")
			{
				$pic_name = "010-4071-8720";
			}
			else if($pic_name == "정승호")
			{
				$pic_name = "070-7777-6752";
			}
			else
			{
            ...
            "* A/S내역 : ".$adminMemo."\n".
			"* 담당 엔지니어 : ".$pic_name."\n".
			"* 연락가능시간 : 10시~12시, 13시~17시\n\n".
            "* 택배사 : ".$parcelCo."\n".
            "* 송장번호 : ".$parcelNo."\n\n".
            "기술 관련 문의는 담당 엔지니어에게 연락 부탁드리며, 기타 문의사항은 고객센터($customerCenter)로 문의해 주시기 바랍니다.";

            $at_CAPI008["senderkey"] = "44970513f96ceef0a7b532fa874d4697ca936dce";
            $at_CAPI008["templatecode"] = "bizp_2025121914434212849642602";
            $at_CAPI008["button"] = $buttons_CAPI008;
