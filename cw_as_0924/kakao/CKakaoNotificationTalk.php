...
$PostMessageResults = [
  POST_MESSAGE_RESULT_USER_ERROR => "[카카오 알림톡] User 에러",
  POST_MESSAGE_RESULT_OK => "[카카오 알림톡] 성공",
  POST_MESSAGE_RESULT_PARAM_ERROR => "[카카오 알림톡] 파라미터 에러",
  POST_MESSAGE_RESULT_FAILED_ERROR => "[카카오 알림톡] SMS 제목이나 내용이 없습니다.",
  POST_MESSAGE_RESULT_BTN_ERROR => "[카카오 알림톡] 버튼 정보가 없습니다.",
  POST_MESSAGE_RESULT_ETC_ERROR => "[카카오 알림톡] 기타 에러",
  POST_MESSAGE_RESULT_UNREGISTERED_NUMBER_ERROR => "[카카오 알림톡] 미등록된 발신번호입니다.",
  POST_MESSAGE_RESULT_POINT_ERROR => "[카카오 알림톡] 충전요금이 부족합니다.",
  POST_MESSAGE_RESULT_NOT_CONFIRMED_TEMPLATE_ERROR => "[카카오 알림톡] 미승인된 템플릿 코드입니다.",
  POST_MESSAGE_RESULT_TEMPLATE_ERROR => "[카카오 알림톡] 템플릿코드 에러가 발생하였습니다.",
  POST_MESSAGE_RESULT_PROFILE_ERROR => "[카카오 알림톡] 프로파일이 존재하지 않습니다.",
];
...
const REPORT_SEND_STATUS_RESULT_FAIL_RECEIVED = 4;
...
$ReportSendStatus = [
  ...
  REPORT_SEND_STATUS_RESULT_FAIL_RECEIVED => "실패메시지결과수신",
];
...
$RegisterSendResultCode = [
  REGISTER_SEND_RESULT_CODE_SUCCESS => "[발신번호 인증/등록] 성공.",
  REGISTER_SEND_RESULT_CODE_PARAMETER_ERROR => "[발신번호 인증/등록] 파라미터 오류가 발생하였습니다.",
  REGISTER_SEND_RESULT_CODE_AUTH_UPDATE_ERROR => "[발신번호 인증/등록] 인증 업데이트 중 에러가 발생하였습니다.",
  REGISTER_SEND_RESULT_CODE_ALEADY_RESISTERED_NUMBER => "[발신번호 인증/등록] 이미 등록된 번호입니다.",
  REGISTER_SEND_RESULT_CODE_AUTH_NUMBER_ERROR => "[발신번호 인증/등록] 일치 하지 않는 인증번호 입니다.",
  REGISTER_SEND_RESULT_CODE_TIMEOUT_ERROR => "[발신번호 인증/등록] 핀코드 인증 시간이 만료되었습니다. 재등록 요청하시기 바랍니다.",
];
...
class CKakaoNotificationTalk {
  ...
  public function getPostMsgResultText($rslt) {
    global $PostMessageResults;
    return( $PostMessageResults[$rslt] );
  }
  ...
  public function getRegisterSenderResultText($rslt) {
    global $RegisterSendResultCode;
    return( $RegisterSendResultCode[$rslt] );
  }
