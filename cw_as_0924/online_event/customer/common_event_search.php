	...
	$query		= "select * from $table where 1";
		if($search_order){
			if($search_item){
				...
				$query.=" and (customer_name like '%$search_order%' or customer_phone like '%$search_order% )";
			}
		}
...
<html lang="en">
  <head>
	...
	<h5 style="color:red;">이벤트 사은품은 주 1회 일괄 발송됩니다.</h5>
	...
	?>
		...
		<tr>
			<td class="text-center"><? echo preg_replace('/.(?=.$)/u','*',$row['customer_name']); ?></td>
			<!--td class="text-center"><? echo $row['event_name'] ?> </td-->
