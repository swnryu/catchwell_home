...
//	$email = $email."@".$email2;
	...
	$query = "insert into cs_online_event set name='$name', hp='$hp', zip_new='$zip_new', add1='$add1', add2='$add2', japum='$japum', gdate='$gdate', shoppingmall='$shoppingmall', id='$id', nickname='$nickname', oid='$oid', content='$content', bbs_file='$file_name', udate=now(), status=0";
...
$button_list1 = array("name"=>"접수 조회", "type"=>"WL", "url_pc" =>"http://www.catchwell.com/b2c/event_query.html", "url_mobile"=>"http://www.catchwell.com/b2c/event_query.html");
$buttons = array($button_list1);
/*
$at["message"] = "안녕하세요. 캐치웰입니다.\n"
.$name." 고객님의 사은품 이벤트 접수가 완료되었습니다.\n".
"사은품은 응모하신 월을 기준으로, 다음달 첫째주 금요일에 일괄 발송됩니다.\n".
...
*/
//20230208 비즈뿌리오 템플릿은 수정이 안되서 템플릿 새로 추가로 인하여 템플릿 내용과 코드 변경
$at["message"] = "안녕하세요. 캐치웰입니다.\n"
.$name." 고객님의 사은품 이벤트 접수가 완료되었습니다.\n".
"사은품은 응모하신 월을 기준으로, 다음달 첫째주 금요일에 일괄 발송됩니다.\n".
"상품평 작성시 부정적 상품평은 제외될 수 있습니다.\n".
"* 이름: ".$name."\n".
"* 휴대폰: ".$hp."\n".
"* 모델명: ".$japum."\n\n".
"휴대폰번호로 접수상태를 조회할 수 있습니다.\n";
...
//$at["templatecode"] = "CAPI003";
$at["templatecode"] = "bizp_2023020215304618819439646";//20230208 템플릿 코드 변경
$at["button"] = $buttons;
...
휴대폰번호로 접수상태를 조회할 수 있습니다.";
		...
		$parameters = array(
			...
			'MSG' => $talkmsg, 
			'TEMPLATE_CODE' => "CAPI003", 
			'FAILED_TYPE' => "SMS", 
			'FAILED_SUBJECT' => "캐치웰", 
			'FAILED_MSG' => "캐치웰 이벤트접수 완료되었습니다. 접수조회:http://www.catchwell.com/b2c/event_query.html" , 
			'BTN_TYPES' => "웹링크", 
			'BTN_TXTS' => "접수 조회",              
			'BTN_URLS1' => "http://www.catchwell.com/b2c/event_query.html"
		);
