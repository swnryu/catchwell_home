...
window.onload=init;
	...
	<h4 class="page-header" style="margin-top:-13px; height:43px;">바코드 송장 조회
	...
	<form method="post" action="online_as_edit_m1_ok.php?idx=<?=$row->idx?>" name="tx_editor_form" enctype="multipart/form-data" style="margin-top:-5px;"> <!--20210105-->
	...
	<th>바코드</th>
		...
		<div class="input-group">
			...
			<input name="parcel_num" class="form-control" autocomplete="off" value="" placeholder="바코드 스캔" onkeyup='if(value.length==12) searchByTrackingNum();' onchange="changeTrackingNum();">
...
function searchByTrackingNum() {
	...
	window.location.href = "online_as_edit_m1.php?tracking_num=" + tracking_num;
}
...
function searchByRegNum() {
	...
	window.location.href = "online_as_edit_m1.php?reg_num=" + reg_num;
}
