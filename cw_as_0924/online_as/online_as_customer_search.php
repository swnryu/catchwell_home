                ...
                for( $i = 0; $i < $result_cnt; $i++ )
                {
                    ...
                    <tr>
                        ...
                        <td data-label="운송장번호(회수)">
                            ...
                            ?> 
                                        <input type="button" value="조회" class="search-button"
                                            onclick="window.open('https://trace.cjlogistics.com/web/detail.jsp?slipno='+'<?php echo $search_db_row[ 'parcel_num' ] ?>',
                                                                 'CJ대한통운 운송장조회',
                                                                 'width=640, height=680, location=no, status=no, scrollbars=yes');">
                                <?php  }
                                    else
                                    { ?>
                                        <input type="button" value="조회" class="search-button"
                        ...
                        <td data-label="운송장번호(출고)">
                            ...
                            ?>
                                    <input type="button" value="조회" class="search-button"
                                        onclick="window.open('https://trace.cjlogistics.com/web/detail.jsp?slipno='+'<?php echo $search_db_row[ 'parcel_num_return' ] ?>',
                                                                'CJ대한통운 운송장조회',
                                                                'width=640, height=680, location=no, status=no, scrollbars=yes');">
                            <?php  } ?>
                        </td>
