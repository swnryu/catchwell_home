                ...
                <div class="card">
                    ...
                    <form name="mobileweb" id="" method="post" class="mt-5" accept-charset="euc-kr">
                        <div class="row g-3 justify-content-between" style="--bs-gutter-x:0rem;">
				    		...
				    		<input type="hidden" name="P_NEXT_URL" value="https://csadmin.catchwell.com/cw_as/PG_M/INImobile_mo_return.php">
							<input type="hidden" name="P_NOTI_URL" value="https://csadmin.catchwell.com/cw_as/PG_M/mx_rnoti.php">
