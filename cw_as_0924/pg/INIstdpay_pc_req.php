...
$mid 			= "CAEcatc44b";  								// 상점아이디			
$signKey 		= "TktsMC9ZSXlZRkxDMjRSZUxldVR0Zz09"; 			// 웹 결제 signkey
                ...
                <div class="card">
                    ...
                    <form name="" id="SendPayForm_id" method="post" class="mt-5">
                        <div class="row g-3 justify-content-between" style="--bs-gutter-x:0rem;">
				    		...
				    		<input type="hidden" name="returnUrl" value="https://csadmin.catchwell.com/cw_as/PG/INIstdpay_pc_return.php">
                            <input type="hidden" name="closeUrl" value="https://csadmin.catchwell.com/cw_as/PG/close.php">
